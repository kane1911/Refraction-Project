...
def open_info_angle():
    ...
    plt.text(-0.1, 0.55, r"$\Rightarrow$" + "by rearanging the formula for the index of refraction one can \n  calculate the refraction angle:", fontsize=11, fontstyle='italic', linespacing=2)
...
def open_info_velocity1():
    ...
    plt.text(-0.1, 0.6,
             r"$\Rightarrow$" + "The velocity can be calculate using the index of refraction (n) of the given\n"
                                " medium and the speed of light through a vacuum (c = " + r"$300 \times 10^{6}$" + " km " + r"$s^{-1}$" + "):",
